...
const DEFS = {
  ...
  car: [
    'M5 11l1.5-4.5A2 2 0 0 1 8.4 5h7.2a2 2 0 0 1 1.9 1.5L19 11',
    'M3 16v-3.2a2 2 0 0 1 1-1.7l1-.6h14l1 .6a2 2 0 0 1 1 1.7V16a1 1 0 0 1-1 1h-1a1 1 0 0 1-1-1v-1H6v1a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1z',
    C(7, 14.5, 0.4),
    C(17, 14.5, 0.4),
  ],
  money: [R(2, 6, 20, 12, 2), C(12, 12, 2.6), L(6, 12, 6.01, 12), L(18, 12, 18.01, 12)],
  users: [
    C(9, 8, 3.2),
    'M2.5 20c.8-3 3.4-4.5 6.5-4.5s5.7 1.5 6.5 4.5',
    'M16 5.5a3.2 3.2 0 0 1 0 6.3',
    'M17.5 15.5c2.4.5 4 2 4.5 4.5',
  ],
  target: [C(12, 12, 9), C(12, 12, 5), C(12, 12, 1)],
  external: ['M14 5h5v5', 'M19 5l-8 8', 'M18 13.5V18a1 1 0 0 1-1 1H6a1 1 0 0 1-1-1V7a1 1 0 0 1 1-1h4.5'],
  pdf: ['M6 3h8l4 4v14H6z', 'M14 3v4h4', 'M8.5 18v-3h1.2a1 1 0 0 1 0 2H8.5', 'M12.5 18v-3h1a1.5 1.5 0 0 1 0 3z', 'M15.8 18v-3h1.7', 'M15.8 16.5h1.2'],
  link: ['M9 15l6-6', 'M10.5 6.5l1-1a3.5 3.5 0 0 1 5 5l-2 2', 'M13.5 17.5l-1 1a3.5 3.5 0 0 1-5-5l2-2'],
  edit: ['M14 5l5 5', 'M4 20l1-4L16 5l3 3L8 19z'],
  trash: ['M4 7h16', 'M9 7V4.5h6V7', 'M6 7l1 13a2 2 0 0 0 2 2h6a2 2 0 0 0 2-2l1-13', L(10, 11, 10, 18), L(14, 11, 14, 18)],
  layers: ['M12 3l9 5-9 5-9-5z', 'M3 13l9 5 9-5', 'M3 17l9 5 9-5'],
  server: [R(3, 4, 18, 7, 2), R(3, 13, 18, 7, 2), L(7, 7.5, 7.01, 7.5), L(7, 16.5, 7.01, 16.5)],
  info: [C(12, 12, 9), L(12, 11, 12, 16), L(12, 8, 12.01, 8)],
  bolt: ['M13 2L4 14h7l-1 8 9-12h-7z'],
  copy: [R(8, 8, 12, 12, 2), 'M16 8V6a2 2 0 0 0-2-2H6a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h2'],
  settings: [
    C(12, 12, 3.2),
    'M19.4 13.5a1.6 1.6 0 0 0 .3 1.8l.1.1a2 2 0 1 1-2.8 2.8l-.1-.1a1.6 1.6 0 0 0-2.7 1.1V21a2 2 0 0 1-4 0v-.1A1.6 1.6 0 0 0 7 19.4l-.1.1a2 2 0 1 1-2.8-2.8l.1-.1A1.6 1.6 0 0 0 3 13.5H3a2 2 0 0 1 0-4h.1A1.6 1.6 0 0 0 4.6 7l-.1-.1a2 2 0 1 1 2.8-2.8l.1.1A1.6 1.6 0 0 0 10 4.6V4a2 2 0 0 1 4 0v.1a1.6 1.6 0 0 0 2.7 1.1l.1-.1a2 2 0 1 1 2.8 2.8l-.1.1a1.6 1.6 0 0 0-.3 1.8 1.6 1.6 0 0 0 1.5 1H21a2 2 0 0 1 0 4h-.1a1.6 1.6 0 0 0-1.5 1z',
  ],
  ...
  help: [C(12, 12, 9), 'M9.2 9.3a3 3 0 0 1 5.6 1c0 2-3 2.3-3 4', L(12, 17.5, 12.01, 17.5)],
  lifebuoy: [C(12, 12, 9), C(12, 12, 4), L(4.9, 4.9, 9.2, 9.2), L(14.8, 14.8, 19.1, 19.1), L(14.8, 9.2, 19.1, 4.9), L(4.9, 19.1, 9.2, 14.8)],
  printer: ['M6 9V3h12v6', 'M6 18H4a2 2 0 0 1-2-2v-3a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v3a2 2 0 0 1-2 2h-2', R(7, 14, 10, 7, 1)],
  sparkle: ['M12 4l1.7 5.1 5.1 1.7-5.1 1.7L12 17.6l-1.7-5.1L5.2 10.8l5.1-1.7z', 'M18.6 3.8l.5 1.6 1.6.5-1.6.5-.5 1.6-.5-1.6-1.6-.5 1.6-.5z'],
};
